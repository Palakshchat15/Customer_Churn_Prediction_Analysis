...
INPUT_MD = os.path.join(BASE_DIR, "report", "Interview_Questions.md")
TEMP_HTML = os.path.join(BASE_DIR, "report", "temp_interview.html")
OUTPUT_PDF = os.path.join(BASE_DIR, "report", "Dashboard_Interview_Questions.pdf")
...
def generate():
    ...
    <head>
        <meta charset="UTF-8">
        <title>Dashboard Interview Questions</title>
        {CSS}
    </head>
    <body>
        {html_content}
